...
namespace BethanysPieShop.TagHelpers
{
    ...
    //TagHelpers contain c# code will generate HTML!
    public class EmailTagHelper : TagHelper
    {
        public string? Address { get; set; }
        public string? Content { get; set; }

        // Process or ProcessAsync() is a reserved method in ASP.NET, which they will automatically look for in TagHelper classes
